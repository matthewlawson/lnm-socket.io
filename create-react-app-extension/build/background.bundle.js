...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actionsTypes__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sendChromeMessage__ = __webpack_require__(48);
// background.js




const socket = __WEBPACK_IMPORTED_MODULE_0_socket_io_client___default()('http://d46f2165.ngrok.io');
...
socket.on('connect', async () => {
  ...
  const packet = {
    type: __WEBPACK_IMPORTED_MODULE_1__actionsTypes__["b" /* messageTypes */].CONNECTION_CHANGE,
...
socket.on(__WEBPACK_IMPORTED_MODULE_1__actionsTypes__["b" /* messageTypes */].MESSAGE_TEXT, async (payload) => {
  messages.push(payload);
  const packet = {
    type: __WEBPACK_IMPORTED_MODULE_1__actionsTypes__["b" /* messageTypes */].MESSAGE_TEXT,
    payload: payload
  }
  try {
...
socket.on('disconnect', async () => {
  connectionStatus = __WEBPACK_IMPORTED_MODULE_1__actionsTypes__["a" /* messagePayloads */].DISCONNECTED;
  const packet = {
    type: __WEBPACK_IMPORTED_MODULE_1__actionsTypes__["b" /* messageTypes */].CONNECTION_CHANGE,
    payload: connectionStatus,
  }
...
function sendMessageFromClient(message) {
  socket.emit(__WEBPACK_IMPORTED_MODULE_1__actionsTypes__["b" /* messageTypes */].SEND_MESSAGE, message);
}
...
chrome.runtime.onMessage.addListener( //eslint-disable-line no-undef
  (request, sender, sendResponse) => {
    console.log(request);
    switch (request.type) {
      case __WEBPACK_IMPORTED_MODULE_1__actionsTypes__["b" /* messageTypes */].FETCH_MESSAGES:
        sendResponse(messages);
        break;
      case __WEBPACK_IMPORTED_MODULE_1__actionsTypes__["b" /* messageTypes */].SEND_MESSAGE:
...
/* harmony export (immutable) */ __webpack_exports__["b"] = messageTypes;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = messagePayloads;
